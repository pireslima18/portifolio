<?php
	...
	if (!$mensagem->mensagemValida()) {
		...
		header('Location: index.php?message=erro1');
		die();
	}
	*/
	...
	try {
		...
		$mensagemRetorno = 'Olá, ' . $nome . '! Seu e-mail foi recebido com sucesso, entrarei em contato assim que possível! Por favor confira os dados abaixo: <br>' . 'Nome: '. $nome . '<br>' . 'E-mail: ' . $email . '<br>' . 'Assunto: ' . $assunto . '<br>' . 'Mensagem: ' . $mensagem . '<br>';
